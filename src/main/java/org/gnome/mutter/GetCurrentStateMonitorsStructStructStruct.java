...
/**
 * Available mode of a physical monitor.
 * <p>
...
public class GetCurrentStateMonitorsStructStructStruct extends Struct {
  ...
  public GetCurrentStateMonitorsStructStructStruct(String member0, int member1, int member2,
      double member3, double member4, List<Double> member5, Map<String, Variant<?>> member6) {
