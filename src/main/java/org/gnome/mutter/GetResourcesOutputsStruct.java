...
public class GetResourcesOutputsStruct extends Struct {
    ...
    public GetResourcesOutputsStruct(UInt32 member0, long member1, int member2, List<UInt32> member3, String member4, List<UInt32> member5, List<UInt32> member6, Map<String, Variant<?>> member7) {
